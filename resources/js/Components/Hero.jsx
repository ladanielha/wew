...
const Hero = () => {
    ...
    <div className="hero min-h-screen bg-base-100">
        <div className="hero-content flex-col lg:flex-row-reverse">
            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/a8/ef/bc/kompleks-goa-peteng-salah.jpg?w=500&h=400&s=1" className="max-w-sm rounded-lg shadow-2xl" />
            <div>
